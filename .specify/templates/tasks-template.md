...
- [ ] T004 Define container build verification commands (build, Ruby version check, jemalloc check)
...
- [ ] T011 Add deterministic build input controls (pin/source docs for base image and packages)
- [ ] T012 Add image hygiene checks (cache cleanup, no embedded secrets)
...
- [ ] TXXX Verify README reflects runtime/build behavior changes
